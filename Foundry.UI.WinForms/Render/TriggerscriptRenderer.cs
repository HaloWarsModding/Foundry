...
namespace Chef.Win.Render
{
    public static class TriggerscriptRenderer
    {
        ...
        private static void DrawUnit(Graphics g, Triggerscript script, Trigger trigger, Selection sel, Selection hover, bool drawDetail)
        {
            ...
            DrawLogicContainer(g, script, trigger, TriggerLogicSlot.Condition, drawDetail);
            DrawLogicContainer(g, script, trigger, TriggerLogicSlot.EffectTrue, drawDetail);
            DrawLogicContainer(g, script, trigger, TriggerLogicSlot.EffectFalse, drawDetail);
        }
        ...
        private static void DrawLogicContainer(Graphics g, Triggerscript script, Trigger trigger, TriggerLogicSlot slot, bool detail)
        {
            ...
            if (slot == TriggerLogicSlot.EffectFalse)
            {
                ...
                {
                    return; //if there is no nodes in this non-conditional trigger, dont draw the section.
                }
