...
namespace Foundry
{
    ...
    internal class InternalModel : ITreeModel
    {
        ...
        public Browser Owner;

        public InternalModel(Browser owner)
        {
            Owner = owner;
        }
    ...
    public class Browser : BaseView
    {
        ...
        public Browser(FoundryInstance i) : base(i)
        {
